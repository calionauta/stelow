...
visual_review filePath=.stelow/{YYYY-MM-DD}/{_dir}/interfaces/interfaces_v{N}.md

# Fallback (bash):
visual_review annotate .stelow/{YYYY-MM-DD}/{_dir}/interfaces/interfaces_v{N}.md --gate --json
```
