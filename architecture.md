...
For the orchestrator skill, the complete Stage Index is in `skills/stelow-adapter-cli/SKILL.md`.

## See Also

- `AGENTS.md` — Agent instructions
- `skills/stelow-adapter-cli/references/cli-tools/todo.md` — Todo system docs
- `skills/stelow-adapter-cli/SKILL.md` — Workflow instructions
---
