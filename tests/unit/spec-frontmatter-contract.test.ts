...
const SETUP_MD = join(PROJECT_ROOT, 'skills/stelow-adapter-cli/stages/setup.md');
const ASK_PATTERNS = join(PROJECT_ROOT, 'skills/stelow-adapter-cli/stages/ask-patterns.md');
