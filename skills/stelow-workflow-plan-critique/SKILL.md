---
name: stelow-workflow-plan-critique
description: >
...
### Via stelow-workflow-tech-planning
...
Input received:
  ...
  │   └→ ❌ Wrong input — use stelow-workflow-codebase-critique or stelow-workflow-ux-critique
...
critique: Critique Gate
  └── stelow-workflow-plan-critique (input: spec-product.md)
...
- **stelow-workflow-ux-critique**: For visual/interface critique (use instead when you have a URL, codebase, or screenshot)
- **stelow-workflow-codebase-critique**: For codebase architecture critique (use instead when you have a code directory)
- **stelow-workflow-execution-critique**: Post-implementation audit (runs after execution to verify completeness)
