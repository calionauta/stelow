---
source: stelow-workflow-plan-critique
applies_to: [plan]
---
...
the narrative supports human review in the visual review gate.
...
> without re-parsing narrative text. The visual review gate still shows the full
