...
```yaml
# anchors at the top of skills/stelow-adapter-cli/stages.yaml
tools:
...
- `skills/stelow-adapter-cli/stages.yaml` — replace `ask` →
  `ask_user_question`, `plannotator` → `visual_review` everywhere.
- `skills/stelow-adapter-cli/references/cli-tools/ask.md` —
  rename to `ask-user-question.md` (or keep filename, update content).
- `skills/stelow-adapter-cli/references/cli-tools/plannotator.md`
  — rename to `visual-review.md` (or keep filename, update content).
- `skills/stelow-adapter-cli/references/cli-tools/README.md` —
...
- `skills/stelow-product-scope-executor/SKILL.md` (line 1019 reference
  table) — same.
- `skills/stelow-adapter-cli/references/capabilities.md` (line 11)
  — same.
- `skills/stelow-adapter-cli/references/cli-tools/todo.md`
  (lines 145, 154) — same.
...
Add to `skills/stelow-adapter-cli/stages.yaml` (right after the
