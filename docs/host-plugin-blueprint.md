...
`preset-staleness`, `decision-api`, `decision-points`, `preset-judge`, `hill-position`, `card-metrics`, `skill-criteria`, `inbox-severity`, `delegation-map`, `draft-burst`. Mirror the pattern (pure `lib/` +
